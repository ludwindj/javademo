...
gulp.task('protractor-complete-test', gulpSequence('browser-sync','protractor-test'));
...
gulp.task('karma-test', function (done) {
  new Server({
    ...
    configFile: 'C:/GIT-PRACTICAS/javademo/src/main/scripts/tests/karma.conf.js',
...
gulp.task('test', gulpSequence('karma-test'));
